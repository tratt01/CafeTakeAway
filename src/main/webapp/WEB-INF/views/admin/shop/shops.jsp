		...
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-6 col-md-8">
						<a href="<c:url value="/admin/shop/add" />" type="button"
			...
			<div class="card-box mb-30">
				<div class="pd-20" style="display: block; text-align: center;">
					<h3 class="text-blue h4 justify-content-center">Danh sách đại lý</h3>
				</div>
				<div class="pb-20">
					<table class=" table stripe hover nowrap">
						<thead>
							<tr>
								<th style="color: blue;">Mã Đại lý</th>
								<th style="color: blue;">Mã Nhân viên</th>
								<th style="color: blue;">Địa chỉ</th>
								<th style="color: blue;">Ngày thanh toán</th>
								<th class="datatable-nosort">Hành động</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="item" items="${ diaDiem }">
								<tr>
										...
										<div class="dropdown">
											...
											<div
												...
												<a class="dropdown-item"
													href="<c:url value="/admin/account/update/${ item.maDiaDiem }" />"><i
													class="icon-copy fa fa-plus" aria-hidden="true"></i>Chỉnh
													sửa </a> 
												<a data-id="${ item.maDiaDiem }" class="dropdown-item"
													href="<c:url value="/admin/account/delete/${ item.maDiaDiem }" />"><i
