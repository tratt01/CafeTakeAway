							...
							<form:form action="/CafeTakeAway/admin/import/addItem"
								...
								<div class="form-row">
									...
									<div class="form-group col">
										...
										<form:input type="text" class="form-control" id="maPN"
											readonly="true" required="" path="maPN" value="${ id }" />
									</div>
									<div class="form-group col">
								...
								<div class="form-row">
									...
									<div class="form-group col">
										...
										<form:input type="number" class="form-control" id="donGia"
											required="" path="donGia" />
									</div>
