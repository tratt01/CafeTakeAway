			...
			<div class="container">
				<div class="row">
					<div class="col-sm-6 col-md-8">
						<a href="<c:url value="/admin/ingredient/add" />" type="button"
							class="btn btn-outline-primary btn-lg m-2 mb-4">Thêm nguyên liệu</a>
					</div>
					...
					<table class=" table stripe hover nowrap">
						<thead>
							<tr>
								...
								<th style="color: blue;">Tên Nguyên liệu</th>
										...
										<div class="dropdown">
											...
											<div
												...
												<a class="dropdown-item"
													href="<c:url value="/admin/ingredient/update/${ item.maNL }" />"><i
													class="icon-copy fa fa-plus" aria-hidden="true"></i>Chỉnh
													sửa </a> 
												<a data-id="${ item.maNL }" class="dropdown-item"
													href="<c:url value="/admin/ingredient/delete/${ item.maNL }" />"><i
