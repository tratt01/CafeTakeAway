		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="page-header">
				<div class="row">
					<div class="col-md-6 col-sm-12">
						<div class="title">
							<h4>Thêm Nguyên liệu vào Phiếu xuất kho</h4>
						</div>
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">
									Thêm Nguyên liệu vào Phiếu xuất kho</li>
							</ol>
						</nav>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-6 col-md-8">
						<a href="<c:url value="/admin/export/addItem/${ id }" />" type="button"
							class="btn btn-outline-primary btn-lg m-2 mb-4">Thêm Nguyên liệu vào Phiếu xuất kho</a>
					</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20" style="display: block; text-align: center;">
					<h3 class="text-blue h4 justify-content-center">Danh sách phiếu xuất</h3>
				</div>
				<div class="pb-20">
					<table class=" table stripe hover nowrap">
						<thead>
							<tr>
								...
								<th style="color: blue;">Đơn vij</th>
								<th class="datatable-nosort">Hành động</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="item" items="${ ct_px }">
								<tr>
								
									<td>${ item.maPX }</td>
									<td><a href="<c:url value="/admin/ingredient/update/${ item.maNL }" />">${ item.tenNL }</a></td>
									<td>${ item.soLuong }</td>
									<td>${ item.donVi }</td>
									<td>
										<div class="dropdown">
											...
											<div
												...
												<a data-id="${ item.maPX }" class="dropdown-item"
													href="<c:url value="/admin/export/deleteItem/${ item.maPX }-${ item.maNL }" />"><i
