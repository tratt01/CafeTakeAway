		...
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-6 col-md-8">
						<a href="<c:url value="/admin/products" />" type="button"
							class="btn btn-outline-primary btn-lg m-2 mb-4">Thêm Khuyến mãi</a>
					</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20" style="display: block; text-align: center;">
					<h3 class="text-blue h4 justify-content-center">Danh sách khuyến mãi</h3>
				</div>
				<div class="pb-20">
										...
										<td>
											<div class="dropdown">
												...
												<div
													...
													<a data-id="${ item.maSP }" class="dropdown-item"
														href="<c:url value="/admin/discounts/delete/${ item.maSP }" />"><i
